...
import org.glassfish.movieplex7.interceptors.SalesInterceptor;
...
@Named
@RequestScoped
@Interceptors({SalesInterceptor.class})
public class SalesBean {
    ...
    public List<Sales> getSalesData() {
    	List<Sales> sales = em.createEntityManager().createNamedQuery("Sales.findAll", Sales.class).getResultList();
    	return sales;
